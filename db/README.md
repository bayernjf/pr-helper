...
3. Copy and run the migration files in numerical order. For a new database, run every migration from `001_users_and_workflows.sql` through `008_workflow_stage_events.sql`.
