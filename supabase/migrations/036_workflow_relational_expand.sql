-- =====================================================
-- Migration 036: Expand workflow payload into relational columns
-- File: 036_workflow_relational_expand.sql
-- Date: 2026-08-21 23:45
-- Depends on: 001_users_and_workflows.sql, 035_generation_rule_content.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Expand step of the payload split: mirrors payload fields into
--       promoted columns plus workflow_stages and
--       workflow_deployment_configs. The jsonb payload remains the only
--       truth; nothing reads these yet and the step is reversible.
-- -----------------------------------------------------
