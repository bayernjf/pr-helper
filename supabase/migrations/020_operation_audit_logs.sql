-- =====================================================
-- Migration 020: Add immutable user operation audit log
-- File: 020_operation_audit_logs.sql
-- Date: 2026-08-03 05:11
-- Depends on: 001_users_and_workflows.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Immutable audit log of user operations (workflow/pull/
--       deployment actions). Rows survive workflow deletion so
--       destructive actions remain traceable.
-- -----------------------------------------------------
