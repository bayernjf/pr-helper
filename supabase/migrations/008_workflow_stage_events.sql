-- =====================================================
-- Migration 008: Add append-only workflow stage event history
-- File: 008_workflow_stage_events.sql
-- Date: 2026-07-29 01:39
-- Depends on: 001_users_and_workflows.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Append-only, user-visible history for GitHub-synchronised
--       workflow stages, deduplicated per (user_id, event_key) and
--       indexed for recent reads.
-- -----------------------------------------------------
