-- =====================================================
-- Migration 035: Store generation rule content per user
-- File: 035_generation_rule_content.sql
-- Date: 2026-08-21 23:21
-- Depends on: 001_users_and_workflows.sql, 015_workflow_versions_and_runs.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Rule content is immutable and was copied once per stage (63% of
--       payload read cost), so it moves to rows keyed by (user_id,
--       content_hash). Backfills payloads and version snapshots; the
--       read path switches over later.
-- -----------------------------------------------------
