-- =====================================================
-- Migration 040: Replace inline generation rule content with hashes
-- File: 040_generation_rule_contract.sql
-- Date: 2026-08-22 03:06
-- Depends on: 035_generation_rule_content.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Contract step of 035: strips inline rule content from payload
--       stages once the read path resolves hashes through
--       pr_helper_generation_rules. Reversible, refuses to finish while
--       any inline content is unresolvable.
-- -----------------------------------------------------
