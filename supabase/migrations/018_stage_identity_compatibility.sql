-- =====================================================
-- Migration 018: Add stable stage identity without breaking stage_index
-- File: 018_stage_identity_compatibility.sql
-- Date: 2026-08-01 02:45
-- Depends on: 017_reconciliation_scope_and_degraded_state.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Adds stage_id across all stage-related tables and backfills it
--       from payloads (or a legacy hash) while keeping stage_index for
--       compatibility. The next migration can switch primary keys.
-- -----------------------------------------------------
