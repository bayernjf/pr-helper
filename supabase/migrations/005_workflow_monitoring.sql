-- =====================================================
-- Migration 005: Add GitHub installation and PR monitoring columns
-- File: 005_workflow_monitoring.sql
-- Date: 2026-07-27 14:28
-- Depends on: 004_workflow_stage_states.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Persistent server-side monitoring state: GitHub installation
--       id on users and head sha, checks, approvals and mergeability
--       on stage states, with supporting indexes.
-- -----------------------------------------------------
