-- =====================================================
-- Migration 028: Add self-expiring leases and pending marker
-- File: 028_reconciliation_leases_and_pending.sql
-- Date: 2026-08-14 21:20
-- Depends on: 027_reconciliation_concurrency_and_fairness.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: A session-level advisory lock could outlive a frozen serverless
--       instance, so reconciliation now uses a lease row with an expiry
--       that any holder can take over. reconcile_pending_since lets a
--       workflow with deferred work jump the rotation.
-- -----------------------------------------------------
