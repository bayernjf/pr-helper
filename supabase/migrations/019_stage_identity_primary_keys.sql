-- =====================================================
-- Migration 019: Make stage_id the canonical stage identity
-- File: 019_stage_identity_primary_keys.sql
-- Date: 2026-08-01 03:56
-- Depends on: 018_stage_identity_compatibility.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Promotes stage_id to NOT NULL and switches primary/foreign keys
--       to (user_id, workflow_id, stage_id, ...). Run only after 018
--       has been verified with zero NULL stage_id rows.
-- -----------------------------------------------------
