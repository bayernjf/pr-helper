-- =====================================================
-- Migration 014: Add reconciliation run telemetry table
-- File: 014_reconciliation_runs.sql
-- Date: 2026-07-31 14:37
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Logs every reconciliation sweep (trigger, state, per-stage
--       counts, duration, error) so sync health is observable.
-- -----------------------------------------------------
