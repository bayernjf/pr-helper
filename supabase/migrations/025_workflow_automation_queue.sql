-- =====================================================
-- Migration 025: Add workflow automation runs and idempotent action queue
-- File: 025_workflow_automation_queue.sql
-- Date: 2026-08-12 10:39
-- Depends on: 001_users_and_workflows.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Versioned automation runs and a queue of idempotent actions
--       (create-pr / merge-pr / advance-stage), deduplicated by
--       (user_id, idempotency_key) with retry bookkeeping.
-- -----------------------------------------------------
