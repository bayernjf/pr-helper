-- =====================================================
-- Migration 030: Keep the reconciliation clock in the database
-- File: 030_reconciliation_pg_cron_clock.sql
-- Date: 2026-08-16 00:04
-- Depends on: 029_reconciliation_github_call_cost.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: GitHub's */10 schedule drifted by 46 minutes at the median, so
--       pg_cron now drives drain and reconcile via a SECURITY DEFINER
--       pinger; the GitHub job stays as fallback. Requires a vault
--       secret pr_helper_cron_secret written outside version control.
-- -----------------------------------------------------
