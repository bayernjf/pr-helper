-- =====================================================
-- Migration 037: Backfill relational workflow rows and verify
-- File: 037_workflow_relational_backfill.sql
-- Date: 2026-08-21 23:54
-- Depends on: 036_workflow_relational_expand.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Backfill step: fills every column and stage/deployment row from
--       payloads, then proves the mirror faithful by rebuilding the
--       workflow from rows and comparing to the payload. Wrapped in an
--       explicit transaction and idempotent.
-- -----------------------------------------------------
