-- =====================================================
-- Migration 015: Add workflow versions and run history
-- File: 015_workflow_versions_and_runs.sql
-- Date: 2026-07-31 14:58
-- Depends on: 001_users_and_workflows.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: workflow_versions snapshots each workflow on change;
--       workflow_runs records each stage execution so active runs can
--       be resumed and history inspected.
-- -----------------------------------------------------
