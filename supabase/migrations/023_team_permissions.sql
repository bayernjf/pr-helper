-- =====================================================
-- Migration 023: Add team membership and workflow sharing
-- File: 023_team_permissions.sql
-- Date: 2026-08-03 06:53
-- Depends on: 001_users_and_workflows.sql
-- Run: Supabase SQL Editor, execute once
-- =====================================================
-- Note: Teams with owner/editor/operator/viewer roles and explicit
--       workflow sharing. Existing workflows remain personal until
--       explicitly shared.
-- -----------------------------------------------------
